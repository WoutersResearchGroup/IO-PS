function [NumIters,Products,M,MAbs,Countries,CountryCompInd,ProductCompInd,CP,Prox,Centrality,DistanceAndOpporGain,Densities,Distance] = CallAllBasicPSMetricsWithoutReadin(CountryLetters,Mat,CA)

MainTime = tic;

ReadInData_Start = tic;

Progress = 'ReadInData_Start'
...
DataReadComplete = toc(ReadInData_Start)
